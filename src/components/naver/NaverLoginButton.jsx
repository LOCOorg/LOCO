...
const NaverLoginButton = () => {
    ...
    return (
        <a
            href={naverLoginUrl}
            className="inline-block px-6 py-3 bg-green-500 text-white text-lg rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500"
        >
            네이버 로그인
        </a>
    );

                                        ...
                                        return (
                                            <>
                                                ...
                                                {onlineFriends.length > 0 && (
                                                    <>
                                                        <div className="px-2 py-1 mb-2 text-sm font-medium text-green-700 bg-green-50 rounded-lg flex items-center gap-2">
                                                ...
                                                {offlineFriends.length > 0 && (
                                                    <>
                                                        <div className="px-2 py-1 mb-2 text-sm font-medium text-gray-600 bg-gray-50 rounded-lg flex items-center gap-2">
